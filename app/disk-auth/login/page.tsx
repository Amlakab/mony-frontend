    ...
    try {
      ...
      if (user && user.role) {
        ...
        if (user.role === 'disk-user') {
          router.push('/disk-user/dashboard');
        }  else {
        ...
        <div id="login-form"  className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Sign in to your account and join the exciting world of multiplayer bingo games
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-100">
              ...
              {message && (
                <div className={`mb-6 p-4 rounded-lg ${message.includes('sent') || message.includes('success') ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'}`}>
                  {message}
                </div>
              )}
                ...
                {/* <div className="text-center">
                  {!isOtpLogin ? (
                    ...
                    <button
                      ...
                      className="text-purple-600 hover:text-purple-800 font-medium transition duration-200 text-sm"
                    >
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Multiplayer Experience</h4>
                      <p className="text-sm text-gray-600">Play with real players in exciting real-time bingo games</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800">Instant Rewards</h4>
                      <p className="text-sm text-gray-600">Win real prizes and enjoy instant withdrawals</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Your data and transactions are protected with encryption</p>
                    </div>
                  </div>
                </div>
              </div>
