...
const menuItems = [
  { name: 'Home', href: '/sub-agent', icon: Home },
  ...
  { name: 'Wallet', href: '/sub-agent/wallet', icon: Wallet },
  { name: 'Referals', href: '/sub-agent/referal', icon: Wallet },
  { name: 'Profile', href: '/sub-agent/profile', icon: Wallet },
];
